...
$(document).ready(function () {
        ...
        client.login(username, password,
            function (err) {
                if (err) {
                    ...
                    client.getLoggedInUser(function(err, response, user) {
                        if(err) {
    ...
    function changeUsersPassword(step, marty) {
        ...
        marty.changePassword(_password, _newpassword,
            function(err) {
                if (err) {
    ...
    function userLikesDog(step, marty, dog) {
        ...
        marty.connect('likes', dog, function (err, response) {
            if (err) {
                ...
                marty.getConnections('likes', function (err, response) {
                    if (err) {
    ...
    function removeUserLikesDog(step, marty, dog) {
        ...
        marty.disconnect('likes', dog, function (err, response) {
            if (err) {
    ...
    function removeDog(step, marty, dog) {
        ...
        dog.destroy(function(err, response) {
            if (err) {
                error('dog not removed');
            } else {
                success('dog removed');
            ...
            if (err) {
                ...
                client.createEntity(options, function (err, response, newdog) {
                    if (err) {
                        ...
                        success('Recreate existing entity failed');
                        ...
                        error('Recreate existing succeeded, but it should have failed.');
                    }
                });
            }
        });
